...
export class PaymentService {
    ...
    public init(params: {
        ...
        this.requestTimeout =
            params.requestTimeout === undefined ? 60000 : params.requestTimeout;
        this.delayTime =
            params.delayTime === undefined ? 100 : params.delayTime;
    ...
    private isResult(params: { func: TFuncCode; status: FUNC_STATUS }) {
        ...
        if (
            status !== FUNC_STATUS.INTERRUPTION_SUCCESS &&
    ...
    public isProcessing(params: { status: FUNC_STATUS }) {
        const status = params.status;
        return (
            status === FUNC_STATUS.APP_PROCESSING ||
        ...
        switch (func) {
            ...
            case FUNC_CODE.EMONEY.SETTLEMENT:
                ...
                requestData = {
                    ...
                    MACHINE_CODE:
                        options.MACHINE_CODE === undefined
                            ? ''
                            : options.MACHINE_CODE,
                    TRANID: options.TRANID === undefined ? '' : options.TRANID,
                    CANTRANID:
                        options.CANTRANID === undefined
                            ? ''
                            : options.CANTRANID,
